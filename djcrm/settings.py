...
SECRET_KEY = 'django-insecure-ywp8es$km$bfyo#l^du^6y*_v5%dn+ns@pc^d4d72x!j-+j$wq'
...
ROOT_URLCONF = 'djcrm.urls'  
    # this is where django starts looking for urls in urls.py

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [ BASE_DIR / "templates" ], #where we gonna put our templates directory
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
